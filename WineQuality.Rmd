...
If indeed there are no outliers per the 1.5•IQR definition, then the data is now clean, having had the locations standardized and being show to have no NA/null values.  We may proceed to exploring a suitable model and checking that the data satisfies the model's assumptions.
